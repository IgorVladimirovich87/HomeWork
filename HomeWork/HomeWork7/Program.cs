...
{
    Console.Write("Input a number of rows: "); // запрашиваем кол-во строк
    int rows = Convert.ToInt32(Console.ReadLine());
    Console.Write("Input a number of columns: "); // кол-во столбцов
    int columns = Convert.ToInt32(Console.ReadLine());
    Console.Write("Input a min possible value: "); // мин значение
    int minValue = Convert.ToInt32(Console.ReadLine());
    Console.Write("Input a max possible value: "); // макс значение
    int maxValue = Convert.ToInt32(Console.ReadLine());
